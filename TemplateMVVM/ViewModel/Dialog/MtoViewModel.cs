...
namespace TemplateMVVM.ViewModel.Dialog
{
    public class MtoViewModel : AutoModel
    {
        ...
        {
            Inicialize();
            WindowLocator.ViewModelLocator.Messenger.GetAutosRegisterMessage(this);
            this.AcceptIsEnabled = true;
        }


        public MtoViewModel(Auto autoParam)
        {
            Inicialize();
